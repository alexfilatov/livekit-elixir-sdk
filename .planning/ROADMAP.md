...
| 11. WebRTC Room Client | 0/4 | Planned    |            |
...
Plans:
- [ ] 11-01-PLAN.md — Rust NIF crate scaffold (Cargo.toml, runtime, atoms, resources, Elixir stub)
- [ ] 11-02-PLAN.md — room_connect + room_disconnect NIFs with full D-12 event forwarding
- [ ] 11-03-PLAN.md — audio_subscribe + audio_publish_frame NIFs with PCM binary transfer
