...
| 12. RoomIO and Agent Session | 2/2 | Complete   | 2026-04-14 |
...
Plans:
- [x] 12-01-PLAN.md — RoomIO GenServer (room audio <-> pipeline bridge) + AgentSession refactor (real Room + RoomIO + Pipeline)
- [x] 12-02-PLAN.md — RoomIO tests with mock Room and Pipeline; AgentSession integration tests
